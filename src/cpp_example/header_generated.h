...
struct Column FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    int32_t width() const { return GetField<int32_t>(VT_WIDTH, -1); }
    int32_t precision() const { return GetField<int32_t>(VT_PRECISION, -1); }
    int32_t scale() const { return GetField<int32_t>(VT_SCALE, -1); }
    bool nullable() const { return GetField<uint8_t>(VT_NULLABLE, 1) != 0; }
    bool unique() const { return GetField<uint8_t>(VT_UNIQUE, 0) != 0; }
...
struct CrsBuilder
{
    ...
    void
    add_code_string(::flatbuffers::Offset<::flatbuffers::String> code_string)
    {
...
inline ::flatbuffers::Offset<Crs>
CreateCrsDirect(::flatbuffers::FlatBufferBuilder &_fbb,
                const char *org = nullptr, int32_t code = 0,
                const char *name = nullptr, const char *description = nullptr,
                const char *wkt = nullptr, const char *code_string = nullptr)
{
...
struct Header FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
{
    ...
    bool has_z() const { return GetField<uint8_t>(VT_HAS_Z, 0) != 0; }
    bool has_m() const { return GetField<uint8_t>(VT_HAS_M, 0) != 0; }
    bool has_t() const { return GetField<uint8_t>(VT_HAS_T, 0) != 0; }
    bool has_tm() const { return GetField<uint8_t>(VT_HAS_TM, 0) != 0; }
...
struct HeaderBuilder
{
    ...
    void
    add_envelope(::flatbuffers::Offset<::flatbuffers::Vector<double>> envelope)
    {
