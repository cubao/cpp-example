...
std::unique_ptr<Expression> id() { return compound("id"); }

std::unique_ptr<Expression> zoom() { return compound("zoom"); }

std::unique_ptr<Expression> eq(std::unique_ptr<Expression> lhs,
                               std::unique_ptr<Expression> rhs)
{
    return std::make_unique<BasicComparison>("==", std::move(lhs),
                                             std::move(rhs));
}
...
Interpolator linear() { return ExponentialInterpolator(1.0); }

Interpolator exponential(double base) { return ExponentialInterpolator(base); }
                                        ...
                                        std::unique_ptr<Expression> output1)
{
    ...
    ParseResult result = createInterpolate(
        type, std::move(interpolator), std::move(input), std::move(stops), ctx);
    assert(result);
    return std::move(*result);
}

std::unique_ptr<Expression>
interpolate(Interpolator interpolator, std::unique_ptr<Expression> input,
            double input1, std::unique_ptr<Expression> output1, double input2,
...
interpolate(Interpolator interpolator, std::unique_ptr<Expression> input,
            double input1, std::unique_ptr<Expression> output1, double input2,
            std::unique_ptr<Expression> output2, double input3,
